    ...
    while 1:
        try:
            ...
            if training_history.shape[0] > 1:
                ...
                ax1.plot(training_history[:, 0], training_history[:, 4], c='blue', label='validation')
                ax1.legend(loc="lower left")
                ax2.plot(training_history[:, 0], training_history[:, 3], c='green', label='train')
                ax2.plot(training_history[:, 0], training_history[:, 6], c='blue', label='validation')
